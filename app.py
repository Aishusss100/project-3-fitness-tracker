...
st.write("This WebApp predicts the calories burned based on parameters like `Age`, `Gender`, `BMI`, etc.")
...
st.write("You have a higher heart rate than", round(sum(boolean_heart_rate) / len(boolean_heart_rate) * 100, 2), "% of other people.")
st.write("You have a higher body temperature than",round(sum(boolean_body_temp) / len(boolean_body_temp) * 100, 2), "% of other people.")
